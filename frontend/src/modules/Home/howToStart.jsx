  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-orange-50 py-16 -mx-6 px-6">
      <div className="max-w-7xl mx-auto">
        <Section
          title="¿Eres Operador Turístico?"
          subtitle="Empieza a recibir reservas en 4 simples pasos"
        >
          {/* Steps Timeline */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Conecta con viajeros de toda Venezuela buscando experiencias
                    únicas
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Solo 10% por reserva confirmada. Sin costos mensuales ni
                    ocultos
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Dashboard intuitivo para manejar reservas, precios y
                    disponibilidad
                  </p>
                </div>
              </div>
