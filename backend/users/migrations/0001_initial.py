...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='operatorprofile', serialize=False, to=settings.AUTH_USER_MODEL)),
                ('organization_name', models.CharField(max_length=200, verbose_name='Nombre de la Organización')),
                ('rif_type', models.CharField(choices=[('V', 'Venezolano'), ('E', 'Extranjero'), ('J', 'Jurídico'), ('G', 'Gubernamental')], max_length=1, verbose_name='Tipo de RIF')),
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pendiente de Aprobación'), ('ACTIVE', 'Activo'), ('SUSPENDED', 'Suspendido')], default='PENDING', max_length=20, verbose_name='Estado')),
            ],
            options={
